...
namespace SokobanSolver
{
    ...
    public class SolFunc
    {
        ...
        public static void createSolution(ref Solution sol, Move lastMove)
        {
            //Console.WriteLine("LastMove: " + lastMove.pos.b[0]);
            if(lastMove.parent != null)
            {
                createSolution(ref sol, lastMove.parent);
            }
            else
            {
            ...
            addMovesBetweenTwoPos(ref sol, lastMove.pos);
        }
        ...
        public static void addMovesBetweenTwoPos(ref Solution sol, Position to)
        {
            calculatePush(to);
            tmpBox = box;
            //Console.WriteLine("BOX: " + box);
            //Console.WriteLine("toBOX: " + toBox);
            //Console.WriteLine("tempBox: " + tmpBox);
        ...
        public static void calculatePush(Position to)
        {
            ...
            for(int f = 0; f < Global.levelInfo.numFields; f++)
            {
                ...
                //Console.WriteLine("HasBoxOn: " + Convert.ToUInt32(Level.hasBoxOn(oldpos.grid[y][x])) + "  tmp % 2: " + tmp % 2);
